                ...
                <div className="col-md-8">
                    ...
                    <div className="process-box">
                        ...
                        <ul className="creat-list">
                            <li><a>Idea & Start</a></li>
                            <li><a>Design & Crate</a></li>
                            <li><a>Build & Finish</a></li>
                        </ul>
                    </div>
                    <a href="#" className="btn anim-button fl-l"><span>View Project</span><i
...
export const Facts =()=>{
    return(
        ...
        <div class="parallax-inner">
            <div class="bg" data-bg="./assets/images/bg/1.jpg" data-top-bottom="transform: translateY(300px);"
