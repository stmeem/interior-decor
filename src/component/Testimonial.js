...
export const Testimonial = ()=>{
    ...
    return(
        ...
        <div className="sect-subtitle left-align-dec" data-top-bottom="transform: translateY(-200px);"
            data-bottom-top="transform: translateY(200px);"><span>06</span></div>
        <div className="parallax-inner">
            <div className="bg" data-bg="images/bg/2.jpg" data-top-bottom="transform: translateY(300px);"
                        ...
                        <div className="testimon-slider-holder">
                            <div className="testimon-slider">
                                ...
                                <div className="item">
                                    ...
                                    <a href="#"className="text-link" target="_blank">Via Twitter</a>
                                </div>
                                ...
                                <div className="item">
                                    ...
                                    <a href="#" className="text-link" target="_blank">Via Facebook</a>
                                </div>
                                ...
                                <div className="item">
                                    ...
                                    <p>"If you are going to use a passage of Lorem Ipsum, you need to be
                                        ...
                                        text."</p>
                                    <a href="#" className="text-link" target="_blank">Via Myspace</a>
                                </div>
                            </div>
